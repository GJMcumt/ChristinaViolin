		...
		<form class="form-horizontal" action="updateGoods" method="post" >
			...
			<div class="control-group">
			 <label class="control-label" for="inputId">goods_id</label>
				<div class="controls">
					<input id="inputId" type="text" name="goods_id" value="${ goods.goods_id}"/>
				</div>
			</div>
			<div class="control-group">
				 <label class="control-label" for="inputName">goods_name</label>
				<div class="controls">
					<input id="inputName" type="text" name="goods_name" value="${goods.goods_name }"/>
				</div>
			</div>
			<div class="control-group">
				 <label class="control-label" for="inputType">type</label>
				<div class="controls">
					<select size="1" name="type" value="${goods.type }">
						<option>1</option>
						<option>2</option>
						<option>3</option>
						<option>4</option>
			...
			<div class="control-group">
				 <label class="control-label" for="inputPrice">price</label>
					<div class="controls">
					<input id="inputPrice" type="text" name="price" value="${goods.price }"/>
				</div>
			</div>		
			<div class="control-group">
				 <label class="control-label" for="inputOther">describe</label>
				<div class="controls">
					<input id="inputOther" type="text" name="describe" value="${goods.describe }"/>
				</div>
			</div>
			<div class="control-group">
				 <label class="control-label" for="inputImage">image(填写图片的名字，如：xx.jpg)</label>
				<div class="controls">
					<input id="inputImage" type="text" name="images" value="${goods.images }"/>
				</div>
			</div>
