...
<body>
	...
	<div class="content">
		<div class="cart">
			<form class="form-horizontal" action="delete_col" method="post" id="loginForm">
				<table>
				<tr>
					<th>商品</th><th>收藏编号</th><th>商品名</th><th>选择</th>
				</tr>
					<c:forEach items="${requestScope.col_detail}" var="col_detail">
					<tr>
						<td><input type="hidden" name="image1" value="${col_detail.image1}"/><img src="images/${col_detail.image1}"/></td>
						<td>${col_detail.collection_sn}</td>
						<td>${col_detail.goods_name}</td>
						<td><input type="radio" name="goods_name" value="${col_detail.goods_name}"/></td>
					</tr>
					</c:forEach>
				</table>
